    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <button
            aria-label="Search"
            className="grid size-10 place-items-center rounded-full hover:bg-white/60"
          >
            <Search className="size-4" />
          </button>
          <button
            aria-label="Account"
            className="hidden size-10 place-items-center rounded-full hover:bg-white/60 sm:grid"
          >
            <User className="size-4" />
          </button>
          <button className="relative grid size-10 place-items-center rounded-full bg-foreground text-background hover:scale-105 transition-transform">
            <ShoppingBag className="size-4" />
            <span className="absolute -right-1 -top-1 grid size-5 place-items-center rounded-full bg-accent-orange text-[10px] font-bold text-white">
              3
            </span>
          </button>
        </div>
